                ...
                <div className="lg:flex">
                    <div className="lg:w-5/12 xl:w-3/12">
                        {!existencia ?
                            ...
                            <img className="opacity-25" src={imagen} alt="Imagen del platillo" />

                            : <img src={imagen} alt="Imagen del platillo" />}
                        <div className="sm:flex sm:-mx-2 pl-2">
                            <label className="block mt-5 sm:w-2/4">
                                <span className="block text-gray-800 mb-2">Existencia</span>
                                <select className="bg-white shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:shadow-outline"
                                    value={existencia}
                                    ref={existenciaRef}
                                    onChange={() => actualizarDisponibilidad()}
                                >
                                    <option className="block" value="true">Disponible</option>
                                    <option value="false">No disponible</option>
                                </select>
                            </label>
                        </div>
                    </div>
                    <div className="lg:w-7/12 xl:w-p/12 pl-5">
